...
plt.semilogy(runner.gap_euclidean["anisotropic"][0:25], label='$\|x^k- x^\star\|_2$', linewidth=linewidth, color="black", linestyle='dashed', marker="X", markevery=5)
plt.semilogy(runner.gap_fstar["anisotropic"][0:25], label='$\|x^k- x^\star\|_q$', linewidth=linewidth, color="black", linestyle='solid', marker="d", markevery=5)
#plt.semilogy(runner.gap_f["anisotropic"][0:25], label='$\|x^k- x^\star\|_p$', linewidth=linewidth, color="black", linestyle='dashdot')
plt.legend()
